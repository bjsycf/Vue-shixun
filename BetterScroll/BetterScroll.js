    ...
    ***************************************************************************** */
    ...
    var ActionsHandler = /** @class */ (function () {
        ...
        ActionsHandler.prototype.handleDOMEvents = function () {
            var _a = this.options, bindToWrapper = _a.bindToWrapper, disableMouse = _a.disableMouse,
                disableTouch = _a.disableTouch, click = _a.click;
            var wrapper = this.wrapper;
        ...
        ActionsHandler.prototype.beforeHandler = function (e, type) {
            var _a = this.options, preventDefault = _a.preventDefault, stopPropagation = _a.stopPropagation,
    ...
    var Behavior = /** @class */ (function () {
        ...
        Behavior.prototype.momentum = function (current, start, time, lowerMargin, upperMargin, wrapperSize, options) {
            ...
            var deceleration = options.deceleration, swipeBounceTime = options.swipeBounceTime,
    ...
    var MouseWheel = /** @class */ (function () {
        ...
        MouseWheel.prototype.wheelMoveHandler = function (delta) {
            ...
            if (throttleTime && this.wheelMoveTimer) {
                ...
                this.cleanCache();
                var _b = this.scroll.scroller, scrollBehaviorX = _b.scrollBehaviorX,
        ...
        MouseWheel.prototype.beforeHandler = function (e) {
            var _a = this.scroll.options, preventDefault = _a.preventDefault, stopPropagation = _a.stopPropagation,
                preventDefaultException = _a.preventDefaultException;
            if (preventDefault &&
                !preventDefaultExceptionFn(e.target, preventDefaultException)) {
                e.preventDefault();
    ...
    var Indicator = /** @class */ (function () {
        ...
        Indicator.prototype.refresh = function () {
            ...
            if (this._setShowBy(this.bscroll[hasScroll])) {
                var _a = this.keysMap, wrapperSize = _a.wrapperSize, scrollerSize = _a.scrollerSize,
    ...
    var ScrollBar = /** @class */ (function () {
        ...
        ScrollBar.prototype.createIndicators = function (bscroll) {
            ...
            var _a = bscroll.options
                    .scrollbar, _b = _a.fade, fade = _b === void 0 ? true : _b, _c = _a.interactive,
    ...
    var Slide = /** @class */ (function () {
        ...
        Slide.prototype.flickHandler = function () {
            var _a = this.scroll.scroller, scrollBehaviorX = _a.scrollBehaviorX, scrollBehaviorY = _a.scrollBehaviorY;
            var currentPosX = scrollBehaviorX.currentPos, startPosX = scrollBehaviorX.startPos,
                directionX = scrollBehaviorX.direction;
            var currentPosY = scrollBehaviorY.currentPos, startPosY = scrollBehaviorY.startPos,
    ...
    var Wheel = /** @class */ (function () {
        ...
        Wheel.prototype.handleHooks = function () {
            var _this = this;
            var scroller = this.scroll.scroller;
            var actionsHandler = scroller.actionsHandler, scrollBehaviorX = scroller.scrollBehaviorX,
                scrollBehaviorY = scroller.scrollBehaviorY, animater = scroller.animater;
    ...
    function checkBeyondBoundary(scroll) {
        var _a = hasScroll(scroll), hasHorizontalScroll = _a.hasHorizontalScroll,
    ...
    function setupData(scroll) {
        var _a = hasScroll(scroll), hasHorizontalScroll = _a.hasHorizontalScroll,
            hasVerticalScroll = _a.hasVerticalScroll;
        var _b = scroll.scroller, actions = _b.actions, scrollBehaviorX = _b.scrollBehaviorX,
            scrollBehaviorY = _b.scrollBehaviorY;
    ...
    var DomManager = /** @class */ (function () {
        ...
        DomManager.prototype.update = function (list, start, end) {
            ...
            var _a = this.positionDom(list, start, end), startPos = _a.startPos, startDelta = _a.startDelta,
                endPos = _a.endPos;
            return {
                start: start,
                startPos: startPos,
    ...
    var InfinityScroll = /** @class */ (function () {
        ...
        InfinityScroll.prototype.update = function (pos) {
            ...
            var _a = this.indexCalculator.calculate(position, this.dataManager.getList()), start = _a.start,
                end = _a.end;
            this.start = start;
            this.end = end;
            // tslint:disable-next-line: no-floating-promises
        ...
        InfinityScroll.prototype.updateDom = function (list) {
            var _a = this.domManager.update(list, this.start, this.end), end = _a.end, startPos = _a.startPos,
                endPos = _a.endPos, startDelta = _a.startDelta;
            if (startDelta) {
